...
public final class Unit implements Identifiable {
	...
	public static final Unit METRE = getOrCreateUnit("nova:metre", "Metre", "m");
	public static final Unit GRAM = getOrCreateUnit("nova:gram", "Gram", "g").setBasePrefix(Prefix.KILO);
	...
	public static final Unit MINECRAFT_JOULES = getOrCreateUnit("buildcraft:minecraft_joule", "Minecraft-Joule", "McJ"); // MJ is confusing with Megajoules
